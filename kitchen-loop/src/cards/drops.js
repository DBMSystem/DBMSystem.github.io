...
// Chance of a card at the end of a loop (spec 4.6), plus the golden dishes' bonus (spec 2.13).
export function loopCardChance(result) {
  ...
  return Math.min(balance.loopCardMax, chance) + balance.goldenCardBonus * (result.goldenCooked ?? 0);
}
