...
export const sfx = {
  ...
  freeze: [NOTE(1760, 0, 0.3, 'sine', 880, 0.4), NOTE(2637, 0.05, 0.35, 'triangle', 1319, 0.25)],
  discard: [NOISE(0, 0.12, 5000, 0.5), NOTE(700, 0, 0.08, 'triangle', 300, 0.4)],
  specialCustomer: arpeggio([659, 880, 1175], 0.07, 0.18, 'triangle', 0.5),
  ...
  cardEpic: [
    NOISE(0, 0.35, 1800, 0.35),
    NOTE(300, 0, 0.3, 'sawtooth', 1200, 0.25),
    NOTE(1568, 0.28, 0.35, 'sine', null, 0.6),
    NOTE(2093, 0.36, 0.4, 'sine', null, 0.5),
  ],
