...
export const decorItems = [
  ...
  { id: 'menu_board', cost: 400, slot: 'wall', x: 30, y: 72, size: 13, draft: true },
  { id: 'copper_lamp', cost: 500, slot: 'ceiling', x: 93, y: 0, size: 8, draft: true },
  { id: 'spice_rack', cost: 650, slot: 'shelf', x: 24, y: 60, size: 13, draft: true },
  { id: 'wall_clock', cost: 800, slot: 'wallHigh', x: 84, y: 3, size: 8, draft: true },
  { id: 'cookie_jar', cost: 1000, slot: 'counter', x: 75, y: 55, size: 6, draft: true },
  { id: 'fairy_lights', cost: 1300, slot: 'top', x: 78, y: 16, size: 38, draft: true },
