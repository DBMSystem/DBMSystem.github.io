...
export const tutorial = {
  ...
  steps: [
    ...
    // The order is guided too (Daniel: a better tutorial hand): bread, then tomato next to it, then cook.
    {
      id: 'order',
      key: 'tutorial.order',
      expression: 'thinking',
      hint: { customer: true, slot: 0, cell: 9 },
      spawnsOrder: true,
      allowedSlots: [0],
      allowedCells: [9],
      until: 'place',
    },
    { id: 'orderTomato', key: 'tutorial.orderTomato', expression: 'happy', hint: { slot: 1, cell: 10 }, allowedSlots: [1], allowedCells: [10], until: 'place' },
    { id: 'orderCook', key: 'tutorial.orderCook', expression: 'surprised', hint: { glowing: true }, allowedSlots: [], allowedCells: [], until: 'toPan' },
